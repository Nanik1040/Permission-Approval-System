...
<a href="ManagerAcceptReq.jsp? peid=<%=rs.getString("peid")%>"> <button type="button" class="btn btn-success">ACCEPT</button></a>
    <a href="ManagerRejectReq.jsp? peid=<%=rs.getString("peid")%>"><button type="button" class="btn btn-danger">REJECT</button></a>
