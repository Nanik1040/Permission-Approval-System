...
<a href="LeaderAcceptReq.jsp? peid=<%=rs.getString("peid")%>"> <button type="button" class="btn btn-success">ACCEPT</button></a>
    <a href="LeaderRejectReq.jsp? peid=<%=rs.getString("peid")%>"><button type="button" class="btn btn-danger">REJECT</button></a>
